...
void packet_arrive_from_network_layer()
{
	...
	if ((pstruEventDetails->pPacket->nControlDataType == 40102 || pstruEventDetails->pPacket->nControlDataType == 40101) && pstruEventDetails->nDeviceId == target_node && is_malicious_node(pstruEventDetails->pPacket->nSourceId))
		{
